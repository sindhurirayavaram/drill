...
public interface ExecConstants {
  ...
  String HTTP_KEYSTORE_PATH = "ssl.server.keyStorePath";
  String HTTP_KEYSTORE_PASSWORD = "ssl.server.keyStorePassword";
  String HTTP_TRUSTSTORE_PATH = "ssl.server.trustStorePath";
  String HTTP_TRUSTSTORE_PASSWORD = "ssl.server.trustStorePassword";
